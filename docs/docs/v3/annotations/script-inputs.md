...
For up-to-date documentation, see the latest version.
      Script inputs
input
annotations make it possible to indicate which variables in the
...
The following examples show how to create, each input and what its
widgets look like.
...
Source input         Previous       plot annotation      Next   Price levels, `hline`