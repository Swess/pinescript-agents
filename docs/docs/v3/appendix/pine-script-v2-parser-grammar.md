...
v3 syntax. Start rule is tvscript:
tvscript : ( stmt )+ ;
...
synpred2_TVScriptParserMain_v2 : FOR_STMT var_def FOR_STMT_TO ternary_expr FOR_STMT_BY ;         Previous       Pine Script v2 lexer grammar