...
It provides quick access to the Pine Script v5 Reference Manual popup when you ctrl / cmd + click on built-in Pine Script constructs, and opens the library publication page when doing the same with construsts imported from libraries.
...
Line 1: //@version=5
 This is a
compiler annotation  telling the compiler the script will use version 5 of
Pine Script.
...
the Editor and choose “New indicator”.
...
Next Steps  page.         Previous       First steps      Next   Next steps              On this pageThe Pine EditorFirst versionSecond versionNext