...
variables.         Previous       Identifiers      Next   Variable declarations              On this pageIntroductionArithmetic operatorsComparison operatorsLogical operators?: ternary operator[] history-referencing operatorOperator precedence= assignement operator:= reassignment operator