...
the
events triggering the execution of a script has occurred.
...
the type of bar or the event where the script is executing. The page where they are
...
least to avoid unexpected results.          Next   Time series              On this pageOverviewCalculation based on historical barsCalculation based on realtime barsEvents triggering the execution of a scriptMore informationHistorical values of functionsWhy this behavior?Exceptions