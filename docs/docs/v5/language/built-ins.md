...
argument supplied to each of the function’s parameters.         Previous       Type system      Next   User-defined functions              On this pageIntroductionBuilt-in variablesBuilt-in functions