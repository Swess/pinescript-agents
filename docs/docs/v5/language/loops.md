...
[var_declaration =] while condition    statements | continue | break    return_expression
...
[var_declaration =] for item in collection_id    statements | continue | break    return_expression
...
[var_declaration =] for [index, item] in collection_id    statements | continue | break    return_expression
