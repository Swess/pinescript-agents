...
<identifier> = <expression><type> <identifier> = <expression>var <identifier> = <expression>var <type> <identifier> = <expression>
...
repeatedly:
<var_declarationX> = for <i> = <from> to <to> by <step>    <var_decl0>    <var_decl1>    ...    continue    ...    break    ...    <var_declN>    <return_expression>
where:
...
loop. It must be indented by 4 spaces.
...
TradingView’s Pine Editor automatically replaces Tab with 4
spaces. ↩