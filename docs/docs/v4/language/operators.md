...
SymbolOperation+Addition-Subtraction*Multiplication/Division%Modulo (remainder after division)
...
SymbolOperation<Less Than<=Less Than or Equal To!=Not Equal==Equal>Greater Than>=Greater Than or Equal To
...
SymbolOperationnotNegationandLogical ConjunctionorLogical Disjunction
...
together with parentheses.         Previous       Type system      Next   Functions and annotations              On this pageArithmetic operatorsComparison operatorsLogical operators?: conditional operator and the iff functionHistory reference operator []Operator precedence