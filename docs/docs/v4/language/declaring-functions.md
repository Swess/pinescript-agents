...
<identifier>(<list of arguments>) =>    <variable declaration>    ...    <variable declaration or expression>
...
plot(res0)
plot(res1)         Previous       Expressions, declarations and statements           On this pageOverviewSingle-line functionsMulti-line functionsScopes in the scriptFunctions that return multiple results